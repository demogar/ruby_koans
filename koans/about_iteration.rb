...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # dgarcia
    # --
    # it takes the first param and assigns it to the first param in the block
    # then, the second param in the block is assigned with the object that is
    # analyzed. finally, it returns the last collected result
  end
